...
public class LivroDAOPilhaDinamica implements LivroDAO {
    ...
    private Empilhavel pilhaLivros = new PilhaDinamica(100);
    ...
    public Livro getLivroPorId(long id) {
        Empilhavel pilhaAuxiliar = new PilhaDinamica(100);
    ...
    public Livro[] getLivrosPorAutor(String autor) {
        Empilhavel pilhaAuxiliar = new PilhaDinamica(100);
        Empilhavel pilhaRetorno = new PilhaDinamica(100);
    ...
    public Livro[] deleteLivrosPorTitulo(String titulo) {
        Empilhavel pilhaAuxiliar = new PilhaDinamica(100);
        Empilhavel pilhaRemovidos = new PilhaDinamica(100);
    ...
    public void clearAllLivros() {
        pilhaLivros = new PilhaDinamica(100);
    }
