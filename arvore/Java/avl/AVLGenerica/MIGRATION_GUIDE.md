...
**Original:**
```bash
java -cp .;bin br.edu.ifba.vdc.bsi.ed.AVLPrincipalCLI
```
...
**Original:**
```bash
javac --release 25 -cp .;bin;lib/junit-4.13.2.jar -d test test/br/edu/ifba/vdc/bsi/ed/AVLTest.java
java -cp .;bin;test;lib/junit-4.13.2.jar;lib/hamcrest-core-1.3.jar org.junit.runner.JUnitCore br.edu.ifba.vdc.bsi.ed.AVLTest
```
...
**Original:**
```bash
jar cvfe build/Main.jar br.edu.ifba.vdc.bsi.ed.AVLPrincipalCLI -C bin .
```
